        ...
        <div className="bg-card rounded-2xl overflow-hidden border border-border shadow-sm">
          ...
          <div className="relative aspect-[16/10]">
            ...
            <div className="absolute top-3 left-3 flex gap-2">
              ...
              <span className="bg-background/90 text-foreground px-2 py-1 rounded text-xs font-medium backdrop-blur-sm border border-border">
                INSTANT BOOK
              </span>
            </div>

            {/* Image counter */}
            <div className="absolute bottom-3 right-3 bg-background/80 backdrop-blur-sm px-2 py-1 rounded text-xs border border-border">
              1 of 8
            </div>
          </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <span className="font-medium text-sm text-foreground">{rating.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="text-right">
                ...
                <p className={`text-xl font-bold ${hasSale ? 'text-highlight' : 'text-foreground'}`}>
                  ${price}
                </p>
